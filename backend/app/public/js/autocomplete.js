    ...
    inp.addEventListener("input", function (e) {
        ...
        for (i = 0; i < players.length; i++) {
            ...
            if ( players[i].name.toUpperCase().startsWith(val.toUpperCase())) {
                ...
                b.innerHTML = `<img src="https://aimarmanci14.eus/football/teams/${players[i].teamId}.png"  width="28" height="28">`;

                /*make the matching letters bold:*/
                b.innerHTML += `<div class='self-center'>
                                    <span class='font-bold'> ${val}</span><span class>${players[i].name.toUpperCase().replace(val.toUpperCase(),'')}</span>
                ...
                b.addEventListener("click", function (e) {
                    ...
                    closeAllLists();
                    addRow(this.children[1].children[3].value);
                });
                a.appendChild(b);
            }
        }
